                                    ...
                                    <table class="date" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            <td>
                                                ...
                                                {{HTML::image("img/email-img/icon-cal.png","icon 1",[ 'width'=>"13",'style'=>"display: block;"])}}
                                            </td>
                                            <td>&nbsp;&nbsp;</td>
                                    ...
                                    <table class="tel" align="center" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            <td>
                                                ...
                                                {{HTML::image("img/email-img/icon-tel.png","icon 2",[ 'width'=>"17",'style'=>"display: block;"])}}
                                            </td>
                                            <td>&nbsp;&nbsp;</td>
                                            <td style="color: #fefefe; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                <singleline>
                                                    Sales : +1 (222) 333-4444
                                                </singleline>
                                            </td>
                                        </tr>
                                        </tbody></table>
                        ...
                        <tbody><tr>
                            <td align="center">
                                <a href="" style="display: block;">
                                     ...
                                     {{HTML::image("img/email-img/vector-lab.jpg","logo",[ 'width'=>"155",'style'=>"display: block;"])}}
                                </a>
...
<tr>
    <td>
        <table class="container-middle" align="center" border="0" cellpadding="0" cellspacing="0" width="560">
            ...
            <tr ><td align="center">
            {{HTML::image("img/email-img/main-img.png","large image",[ 'width'=>"538",'style'=>"display: block;",'class'=>"main-image" ,"height" =>'auto'])}}
            </td></tr>
                                        ...
                                        <td  style="color: #a4a4a4; line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                            <table class="section-item" align="left" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="300">{{$candidate->first_name." ".$candidate->last_name}}</td>
                                                </tr>
                                                <tr>
                                                    <td width="100">Gender</td>
                                                    <td width="300">{{$candidate->gender == 'M' ? 'Male' : "Female"}}</td>
                                                </tr>

                                                <tr>
                                                    <td width="100">Mobile</td>
                                                    <td width="300">{{$candidate->mobile_phone}}</td>
                                                </tr>

                                                <tr>
                                                    <td width="100">Skills</td>
                                                    <td width="300">Rahul Singh</td>
                                                </tr>
                                                <tr>
                                                    <td width="100">Marital Status</td>
                                                    <td width="300">{{$candidate->merital_status}}</td>
                                                </tr>
                                                <tr>
                                                    <td width="100">Date Of Birth</td>
                                                    <td width="300">{{$candidate->date_of_birth ? $candidate->date_of_birth : "N/A"}}</td>
                                                </tr>
                                                <tr>
                                                    <td width="100">Address</td>
                                                    <td width="300">{{$candidate->address." ,".$candidate->city}}</td>
                                                </tr>

                                                <tr>
                                                    <td width="100">Current Salary</td>
                                                    <td width="300">{{$candidate->current_salary}} Lakhs</td>
                                                </tr>
                                                <tr>
                                                    <td width="100">Expected Salary</td>
                                                    <td width="300">{{$candidate->expt_salary}} Lakhs</td>
                                                </tr>
                                                <tr>
                                                    <td width="100">Notice Period</td>
                                                    <td width="300">{{$candidate->notice_period}} Days</td>
                                                </tr>
...
<tr>
    <td style="color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-header" align="center">
        ...
        You are currently signed up to Company’s newsletters as: <span style="color: #7087A3">dkmosa@gmail.com</span> to unsubscribe <a style="text-decoration: none; color: #7087A3;" href="#">click here</a>
...
<tr>
    <td  style="color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-subheader" align="center">
        ...
        <span style="color: #7087A3">Adress :</span> 3423 Dream Land &nbsp;&nbsp;&nbsp;   <span style="color: #7087A3">Phone :</span> 123233243    &nbsp;&nbsp;&nbsp;<span style="color: #7087A3">Email :</span> dkmosa(@)gmail.com
...
<table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
    ...
    <tr bgcolor="7087A3">
        <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
            ...
            FlatLab © Copyright 2013 . All Rights Reserved
